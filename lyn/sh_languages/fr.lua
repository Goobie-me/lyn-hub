...
extra = {
    no_tool_permission = "Tu n'as pas la permission d'utiliser l'outil {red %tool%}",
    no_spawn_permission = "Tu n'as pas la permission {red %name%}",
}

teams = {
    tab = "Équipes",
    has_team = "Le rôle a une équipe",
...
commands = {
    ...
    playerextendrole = {
        help = "Prolonger l'expiration du rôle d'un joueur.",
        notify = "{P} a prolongé le rôle {green %role%} de {T} de {D}",
    },

    playerextendroleid = {
        help = "Prolonger l'expiration du rôle d'un joueur par son SteamID/SteamID64.",
        notify = "{P} a prolongé le rôle {green %role%} de {red %target_steamid64%} de {D}",
    },
    ...
    setteam = {
        help = "Définir l'équipe d'un rôle.",
        notify = "{P} a défini l'équipe du rôle {red %role%} sur {green %name%}",
    },

    removeteam = {
        help = "Supprimer l'équipe d'un rôle.",
        notify = "{P} a supprimé l'équipe du rôle {red %role%}",
    },
}
